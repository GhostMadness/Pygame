    ...
    def start_location_3():
        if __name__ == '__main__':
            ...
            while running:
                ...
                screen_3.blit(gg.image, gg.rect)
...
class Location_2():
    ...
    def start_location_2():
        if __name__ == '__main__':
            ...
            other_sprites.add(Stop("SPRITE\VIXOD_LOC.png", (1867, 543)))
...
class Location_1():
    ...
    if __name__ == '__main__':
        pygame.init()
        global left_sprites, right_sprites, top_sprites, bottom_sprites, screen, img, gg, sh1, music, x, y
